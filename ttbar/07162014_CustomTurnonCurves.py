...
filename_noNoiseCut    = "data/seed%d/leading_jets_%s.pkl" % (args.seedEt_thresh, filename_id_noNoiseCut)
filename_wNoiseCut     = "data/seed%d/leading_jets_%s.pkl" % (args.seedEt_thresh, filename_id_wNoiseCut)
...
plotStrings = [\
  '$|\eta^\mathrm{oJet}| \leq 1.6$\nanti-$K_T\ R=1.0$ (5% trimmed)\n$N\left(P_T^{D=0.3\ \mathrm{subjet}} > 20\ \mathrm{GeV}\\right) \geq 1$',\
  '$|\eta^\mathrm{oJet}| \leq 1.6$\n$100 \leq m^\mathrm{oJet} \leq 220$ GeV\nanti-$K_T\ R=1.0$ (5% trimmed)\n$N\left(P_T^{D=0.3\ \mathrm{subjet}} > 20\ \mathrm{GeV}\\right) \geq 1$',\
  '$|\eta^\mathrm{oJet}| \leq 1.6$\n$100 \leq m^\mathrm{oJet} \leq 220$ GeV\nanti-$K_T\ R=1.0$ (5% trimmed)\n$N\left(P_T^{D=0.3\ \mathrm{subjet}} > 20\ \mathrm{GeV}\\right) \geq 2$',\
  '$|\eta^\mathrm{oJet}| \leq 1.6$\n$100 \leq m^\mathrm{oJet} \leq 220$ GeV\nanti-$K_T\ R=1.0$ (5% trimmed)\n$N\left(P_T^{D=0.3\ \mathrm{subjet}} > 20\ \mathrm{GeV}\\right) \geq 3$']
